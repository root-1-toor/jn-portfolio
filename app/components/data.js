...
export const PROJECTS = [
  ...
  },
  {
    ...
    year: "2020–Present",
    desc: "Contributing to MERN stack for the US Consumer Card Shop. Built the 'check-for-offers' endpoint boosting user engagement by 15% for 100,000+ daily users. Led Angular → React migration, cutting cross-browser issues. Led Agile sprints with Jenkins and Jest cutting deployment time 20% via CI/CD pipelines.",
